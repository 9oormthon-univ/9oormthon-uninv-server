...
import { IdeaSubjectRepository } from './idea-subject.repository';
...
import { IdeaSubjectMapper } from '../infra/orm/mapper/idea-subject.mapper';

export class IdeaSubjectRepositoryImpl implements IdeaSubjectRepository{
